    ...
    <div class="Main_header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    <div class="p-2">
                        <img src="{{asset('engineer_company/assets/images/logo.png')}}" alt="image" height="40">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $( '#loginForm' ).validate( {
            submitHandler: function () {
                'use strict';
                ajaxCall($('#loginForm'), "{{ route('engineer_login_action') }}", $('#login_btn'), "{{ route('ec.GetCustomerInfoListing') }}", onRequestSuccess);
            }
        } );
</script>
