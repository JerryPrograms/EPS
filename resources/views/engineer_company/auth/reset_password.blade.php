            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('UpdateResetPassword') }}">
                            @csrf
                            @if(request()->session()->has('password_error'))
                                <span class="row text-danger">{{request()->session()->get('password_error')}}</span>
                            @endif
                            ...
                            <input name="model" value="{{$model}}" hidden>
