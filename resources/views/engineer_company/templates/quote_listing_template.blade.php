<table class="table align-middle mb-0 table-theme">
    ...
    <tr>
        ...
        <td class="d-flex gap-1">
            <button data-bs-toggle="modal" data-bs-target="#exampleModal0" class="btn btn-outline-danger btn-theme-danger-outline btn-outline btn-sm">
            ...
            <button onclick="window.location.href = '{{route("ec.PDFQuote",$q->id)}}'" class="btn btn-outline-light btn-theme-light-outline btn-outline btn-sm">
