<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{asset('engineer_company/assets/css/bootstrap.min.css')}}" id="bootstrap-style" rel="stylesheet"
          type="text/css"/>
    <!-- Icons Css -->
    ...
    <link rel="stylesheet" href="{{asset('engineer_company/assets/css/flatpickr.min.css')}}">
