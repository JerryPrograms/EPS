...
(function (e) {
    e.extend(e.fn, {
        ...
        messages: {
            ...
            digits: "숫자 만 입력하십시오.",
            creditcard: "유효한 신용 카드 번호를 넣어주세요.",
            equalTo: "같은 값을 다시 입력 해주세요.",
            maxlength: e.validator.format("{0}자 이하로 입력하십시오."),
            minlength: e.validator.format("{0}자 이상 입력하세요."),
            rangelength: e.validator.format("{0}에서 {1}자 사이의 값을 입력하십시오."),
            range: e.validator.format("{0}에서 {1} 사이의 값을 입력하십시오."),
            max: e.validator.format("{0} 이하의 값을 입력하십시오."),
            min: e.validator.format("{0} 이상의 값을 입력하십시오.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
